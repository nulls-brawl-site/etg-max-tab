...
The loader stores the downloaded dex under ExteraGram's private plugin directory: `get_plugins_dir()/etg_max/etg-max-bridge.dex`. It marks the dex read-only before loading because recent Android versions reject writable dex files.
